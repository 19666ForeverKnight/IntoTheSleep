...
public class FastPIDConst {
    ...
    public static final CustomFilteredPIDFCoefficients FastDrivePIDF = new CustomFilteredPIDFCoefficients(driveP1, driveI1, driveD1, driveT1, driveF1);
    ...
    public static final CustomFilteredPIDFCoefficients FastSecondaryDrivePIDF = new CustomFilteredPIDFCoefficients(driveP2, driveI2, driveD2, driveT2, driveF2);
    ...
    public static final CustomPIDFCoefficients FastTransPIDF = new CustomPIDFCoefficients(transP1, transI1, transD1, transF1);
    ...
    public static final CustomPIDFCoefficients FastSecondaryTransPIDF = new CustomPIDFCoefficients(transP2, transI2, transD2, transF2);
    ...
    public static final CustomPIDFCoefficients FastHeadingPIDF = new CustomPIDFCoefficients(headingP1, headingI1, headingD1, headingF1);
    ...
    public static double zeroPower = 4.0;
}
